...
export const Footer = () => {
  return (
    <footer className='flex justify-around items-center px-8 mt-4 py-2 flex-wrap md:flex-nowrap border-t-2'>  
        ...
        <div className='flex flex-col items-center justify-center gap-1 w-full md:w-1/3'>
            ...
            <ul className='flex justify-around items-center gap-8'>
                <li>
                    <Link><img width="48" height="48" src="https://img.icons8.com/fluency/48/instagram-new.png" alt="instagram-new"/></Link>
                </li>
                <li>
                    <Link><img width="48" height="48" src="https://img.icons8.com/color/48/facebook.png" alt="facebook"/></Link>
                </li>
                <li>
                    <Link><img width="48" height="48" src="https://img.icons8.com/fluency/48/linkedin.png" alt="linkedin"/></Link>
                </li>
            </ul>
        </div>
        <div className='w-full md:w-1/3 flex flex-col items-center justify-center gap-2 '>
