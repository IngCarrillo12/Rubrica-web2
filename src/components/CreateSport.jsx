  ...
  return (
    ...
    <form action="#" onSubmit={handleSubmit}  className="flex flex-col gap-6 p-6">
        ...
        <div className='flex flex-col w-1/2 gap-2'>
            ...
            <input placeholder='Ej: Futbol' className='h-8 pl-4 border rounded-md focus:outline-none focus:border-2 transition-colors focus:border-blue-500' type="text" name='title' value={sport.title} onChange={handleChange} />
        </div>
        <div className='flex flex-col w-1/2 gap-2' >
            <label className='font-semibold text-base' htmlFor="">Category:</label>
            <select name='category' className='h-8 pl-4 border rounded-md focus:outline-none focus:border-2 transition-colors focus:border-blue-500'  onChange={handleChange}>
